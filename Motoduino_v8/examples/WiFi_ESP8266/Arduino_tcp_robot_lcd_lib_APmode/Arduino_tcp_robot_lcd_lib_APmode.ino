/////////////////////////////////
//// 功能: WiFi手機無線遙控車 (ESP8266)   AP Mode
//// 日期: June 2016 
//// 作者: Dennis
//////////////////////////
...
SoftwareSerial esp8266(3,2);  // use pins 7, 8 for software serial //S4A IO Board
LiquidCrystal_I2C lcd(0x27,16,2);  // set the LCD address to 0x27 for a 16 chars and 2 line display

#define AP_SSID  "ESP8266"      // change this to match your WiFi SSID
#define PASSWORD  "123456789"  // change this to match your WiFi password
 ...
 pinMode(LED_CONNECT_PIN, OUTPUT);
  ...
  Serial.println("begin.");
    ...
    if (wifi.setOprToSoftAP()) {
        Serial.print("set to SoftAP mode ok\r\n");
    } else {
        Serial.print("set to SoftAP mode err\r\n");
    }

    wifi.setSoftAPParam(AP_SSID, PASSWORD,5, 0);  //3: WPA2
