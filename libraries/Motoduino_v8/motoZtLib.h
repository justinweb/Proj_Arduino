...
//////////////////
#define ZTSEG8B4A036A_DADDR (0x65) //
...
#define REG_IMAGE        0x50
#define REG_6X8ENSTR     0x51
#define REG_8X16ENSTR    0x52
#define REG_16X16CNSTR   0x53
...
#define DECNUM_5BIT     (0x01)
#define DECNUM_AUTO     (0x00)
...
// Module ZT.SC-I2CMx    
    ...
    int ScI2cMxDisplay6x8Str(uint8_t, uint8_t, uint8_t, const char *);
    int ScI2cMxDisplay6x8DecNum(uint8_t, uint8_t, uint8_t, uint16_t,uint8_t);
    int ScI2cMxDisplay8x16Str(uint8_t, uint8_t, uint8_t, const char *);
    int ScI2cMxDisplay8x16DecNum(uint8_t, uint8_t, uint8_t, uint16_t,uint8_t);
    int ScI2cMxDisplayGb2132Str(uint8_t, uint8_t, uint8_t, const char *, uint8_t);
